	...
	public class SkillJian3 extends BaseSkillVo
	{
		...
		public static function getTableVo():SkillTableVo
		{
			if (tableVo == null){
				...
				tableVo.id = id;
				tableVo.cls = SkillJian3;
				tableVo.name = "普攻三段"; 
				tableVo.info = "剑系普攻第三段攻击";
				tableVo.xi = SkillTable.XI_JIAN;
				tableVo.startState = SkillTable.FLOOR;
				tableVo.frameName = "剑3";
				tableVo.needGold = 50;
				tableVo.needDay = 1;
				tableVo.up1Name = "重击";
				tableVo.up1Info = "必定暴击";
				tableVo.up1Gold = 100;
				tableVo.up1Day = 3;
				tableVo.up2Name = "致命";
				...
				tableVo.up2Gold = 100;
				tableVo.up2Day = 3;
				tableVo.canCancelAfter = [SkillJian2.id];
				tableVo.skillComboTime = 30;
			}
			return tableVo;
		}
		
		public function SkillJian3()
		{
			super();
		...
		override public function start():void
		{
			...
			attSpot.attr.critDmg = roleVo.curAttr.attArmor;
			
			if (type == 1){ // 升级效果,暴击伤害加3
				attSpot.attr.critDmg += 3;
			}else if (type == 2){ // 升级效果,必定暴击
				attSpot.isCrit = true;
			}
