package dyzm.data.skill
{
	...
	public class SkillJian4 extends BaseSkillVo
	{
		/**
		 * 技能唯一标识
		 */
		public static const id:String = "剑4";
		/**
		 * 名称
		 */
		public static const name:String = "剑系普攻四段";
		 ...
		 * 帧名称
		 */
		public static const frameName:String = "剑4";
		
		/**
		 * 可以打断的后摇
		 */
		public const CAN_CANCEL_AFTER:Array = ["剑3"];
		...
		public function SkillJian4(role:RoleVo)
		{
			super(role);
