package dyzm.data
{
	public class BgData
	{
		...
		public static const bg1bg:Array = [
			["res/bg/bg1_1.png",	0,		-80, 	1592, 	1,	1, 	1,	0.2, 	700, 	0, 		0.2, 	0],
			["res/bg/bg1_1.png",	1592, 	-80, 	1592, 	1,	-1,	1, 	0.2, 	700, 	0, 		0.2, 	0], 
			["res/bg/bg1_2.png",	500, 	-20, 	3000, 	1,	1, 	1, 	0.05, 	700, 	0, 		0.1, 	0], 
			["res/bg/bg1_4.png",	0, 		385, 	318, 	1,	1, 	1, 	1, 		700, 	0, 		0.3, 	0],
			["res/bg/bg1_3.png",	0, 		133, 	1591, 	1,	1, 	1, 	0.5, 	700,  	0.05, 	0.3, 	0]
		];
		public static const bg1Front:Array = [
			["res/bg/bg1_5.png",	0, 		659, 	868, 	1, 	1, 	1, 	1, 		700,	0.2, 	0.4,	0]
		];
